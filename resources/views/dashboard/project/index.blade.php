                    ...
                    <tbody>
                        @foreach ($projects as $item)
                            <tr class="odd:bg-white even:bg-neutral-100 border-b border-default">
                                ...
                                <td class="px-6 py-4">
                                    <button type="button" data-drawer-target="drawer-edit-example"
                                        data-drawer-show="drawer-edit-example" data-drawer-placement="right"
                                        data-project="{{ $item }}" onclick="openEditDrawer(this)"
                                        class="font-medium text-fg-brand hover:underline">Edit</button>
                                    <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                                        data-project-id="{{ $item->id }}" onclick="setDeleteAction(this)"
